#ifndef MYREALM_CORE_EXPORTS_H
#define MYREALM_CORE_EXPORTS_H
    ...
    #if defined(MyREALM_Core_DLL_EXPORT)
        #define MyREALM_Core_API __declspec(dllexport)
    #else
        #define MyREALM_Core_API __declspec(dllimport)
    #endif
